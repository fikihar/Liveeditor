<?php
// Tulis ulang Dashboard Siswa yang bersih dari karakter rusak
$siswaDash = <<<'HTML'
<!DOCTYPE html>
<html lang="id">
<head>
...
HTML;
file_put_contents(__DIR__ . '/resources/views/siswa/dashboard.blade.php', $siswaDash);

// Hapus emoji/icon aneh dari CSS siswa (karena ada pseudo-element)
$siswaCss = file_get_contents(__DIR__ . '/public/css/siswa.css');
$siswaCss = str_replace('content: "📋";', 'content: "";', $siswaCss);
$siswaCss = str_replace('content: "💡";', 'content: "";', $siswaCss);
file_put_contents(__DIR__ . '/public/css/siswa.css', $siswaCss);

echo "Siswa Dashboard Fixed.\n";

// Perbaiki view Siswa Editor (Buang emoji rocket roket dan alert peringatan)
$editorSiswa = file_get_contents(__DIR__ . '/resources/views/siswa/editor.blade.php');
$editorSiswa = str_replace('Hasil 🚀', 'Hasil', $editorSiswa);
$editorSiswa = str_replace('⚠️ PERINGATAN', 'PERINGATAN', $editorSiswa);
file_put_contents(__DIR__ . '/resources/views/siswa/editor.blade.php', $editorSiswa);
echo "Siswa Editor Fixed.\n";
?>