...
$html = preg_replace("/@section\('topbar-actions'\).*?@endsection/is", "@section('topbar-actions')
    <div style=\"display:flex;gap:8px;align-items:center;\">
      ...
      <form action=\"{{ route('guru.tugas.destroy', \$assignment) }}\" method=\"POST\" class=\"form-delete\" data-confirm=\"Semua jawaban siswa terkait tugas ini akan ikut terhapus secara permanen!\" style=\"margin:0;\">
        @csrf
        @method('DELETE')
...
echo "Added Back button to show.blade.php topbar actions.\n";
?>